...
export const StickyActions: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Official WhatsApp App SVG Logo Action */}
      <a
        href={whatsappUrl}
        target="_blank"
